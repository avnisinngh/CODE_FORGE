  ...
  return (
    <section className="flex flex-col items-center text-center py-20 px-6 md:px-12 lg:px-24 bg-[#0a0f2c]">
      ...
      <div className="flex flex-col md:flex-row gap-6 mt-6">
        <motion.div whileHover={{ scale: 1.1 }}>
          <Button
            className="bg-[#e0e0ff] text-[#0a0f2c] flex items-center gap-2 shadow-s shadow-[#8faba2]"
        ...
        <motion.div whileHover={{ scale: 1.1 }}>
          <Button
            className="bg-[#e0e0ff] text-[#0a0f2c] flex items-center gap-2 shadow-lg shadow-[#899b95]"
            onClick={handleDonateNowClick}
          >
